	   ...
	   <!----EDITING FORM STARTS---->
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('atendente/gerenciar_agenda/edit/do_update/'.$row['agenda_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
	    ...
	    <!----TABLE LISTING STARTS--->
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<a href="<?php echo base_url();?>index.php?atendente/gerenciar_agenda/edit/<?php echo $row['agenda_id'];?>"
                                	rel="tooltip" data-placement="top" data-original-title="Editar" class="btn btn-blue">
                                		<i class="icon-wrench"></i>
                                </a>
							
                            	<a href="<?php echo base_url();?>index.php?atendente/gerenciar_agenda/delete/<?php echo $row['agenda_id'];?>" onclick="return confirm('delete?')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('atendente/gerenciar_agenda/create/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
