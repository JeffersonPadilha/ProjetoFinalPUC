		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('atendente/gerenciar_paciente/edit/do_update/'.$row['paciente_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
...
<?php echo form_open_multipart(base_url().'/application/controllers/upload.php?paciente_id='.$row['paciente_id']);?>
...
<hr>
  ...
  <!----TABLE LISTING STARTS--->
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="<?php echo base_url().'/application/controllers/apagar.php?anexo='.$row5['patch'].'&paciente_id='.$row['paciente_id'];?>" onclick="return confirm('delete?')"
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	<a href="<?php echo base_url();?>index.php?atendente/gerenciar_paciente/edit/<?php echo $row['paciente_id'];?>"
                                	rel="tooltip" data-placement="top" data-original-title="Editar" class="btn btn-blue">
                                		<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?atendente/gerenciar_paciente/delete/<?php echo $row['paciente_id'];?>" onclick="return confirm('delete?')"
                                	rel="tooltip" data-placement="top" data-original-title="Delete" class="btn btn-red">
                                		<i class="icon-trash"></i>
                                </a>
        					</td>
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('atendente/gerenciar_paciente/create/' , array('class' => 'form-horizontal validatable'));?>
