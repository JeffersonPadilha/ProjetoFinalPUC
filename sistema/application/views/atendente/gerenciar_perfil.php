			...
			<div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content padded">
                    ...
                    foreach($edit_profile as $row):
                        ?>
                        <?php echo form_open('atendente/gerenciar_perfil/update_profile_info/' , array('class' => 'form-horizontal validatable'));?>
		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content padded">
                    ...
                    foreach($edit_profile as $row):
                        ?>
                        <?php echo form_open('atendente/gerenciar_perfil/change_password/' , array('class' => 'form-horizontal validatable'));?>
                                <div class="control-group">
                                ...
                                <div class="form-actions">
                            		<button type="submit" class="btn btn-blue">Alterar senha</button>
                        		</div>
                        <?php echo form_close();?>
						<?php
                    endforeach;
