                    ...
                    <ul class="dropdown-menu">
                    	<li class="with-image">
                            ...
                            <?php 
								...
								$name			=	$this->crud_model->get_type_name_by_id($account_type , $this->session->userdata($account_id) , 'nome');
								echo $name;
							?>
                            </span>
                        </li>
                    	<li class="divider"></li>
						<li><a href="<?php echo base_url();?>index.php?<?php echo $this->session->userdata('login_type');?>/gerenciar_perfil">
