			...
			<div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content padded">
                    ...
                    foreach($edit_profile as $row):
                        ?>
                        <?php echo form_open('medico/gerenciar_perfil/update_profile_info/' , array('class' => 'form-horizontal validatable'));?>
		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content padded">
                    ...
                    foreach($edit_profile as $row):
                        ?>
                        <?php echo form_open('medico/gerenciar_perfil/change_password/' , array('class' => 'form-horizontal validatable'));?>
                                <div class="control-group">
