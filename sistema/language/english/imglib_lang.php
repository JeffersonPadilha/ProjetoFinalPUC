...
$lang ['imglib_gif_not_supported'] = "As imagens GIF geralmente não são suportadas devido a restrições de licença. Você pode ter que usar imagens JPG ou PNG.";
...
$lang ['imglib_copy_error'] = "Foi encontrado um erro ao tentar substituir o arquivo. Verifique se o diretório do seu arquivo é gravável.";
$lang ['imglib_rotate_unsupported'] = "A rotação da imagem não parece ser suportada pelo seu servidor.";
$lang ['imglib_libpath_invalid'] = "O caminho da sua biblioteca de imagens não está correto. Por favor, defina o caminho correto nas suas preferências de imagem.";
...
$lang ['imglib_save_failed'] = "Não foi possível salvar a imagem. Verifique se o diretório da imagem e do arquivo está gravável.";
